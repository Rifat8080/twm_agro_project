class Users::RegistrationsController < Devise::RegistrationsController
    ...
    def individual_params
      params.require(:individual).permit(:full_name) if params[:user][:role] == "individual"
    end
  
    def organization_params
      params.require(:organization).permit(:organization_name) if params[:user][:role] == "organization"
    end
  end
